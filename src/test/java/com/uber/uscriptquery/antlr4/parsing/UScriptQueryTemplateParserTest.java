...
public class UScriptQueryTemplateParserTest {
    ...
    public void test_parse() {
        {
            ...
            UScriptQueryTemplateParser parser = new UScriptQueryTemplateParser();
            UScriptQueryTemplateParseResult root = parser.parse(query);
