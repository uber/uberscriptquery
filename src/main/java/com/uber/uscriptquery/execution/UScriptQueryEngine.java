...
import com.uber.uscriptquery.antlr4.parsing.*;
import com.uber.uscriptquery.util.CredentialProvider;
import com.uber.uscriptquery.util.DummyCredentialProvider;
import com.uber.uscriptquery.util.SparkUtils;
...
public class UScriptQueryEngine implements Serializable {
    ...
    private static final Logger logger = LoggerFactory.getLogger(UScriptQueryEngine.class);
    ...
    public void executeScript(String query, String queryOverwrite, SparkSession spark, boolean debug) {
        UScriptQuerySqlParser parser = new UScriptQuerySqlParser();
        ...
        UScriptQueryActionEngine actionExecutor = new UScriptQueryActionEngine();
