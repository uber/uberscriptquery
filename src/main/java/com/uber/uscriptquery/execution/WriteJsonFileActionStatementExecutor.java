...
public class WriteJsonFileActionStatementExecutor implements ActionStatementExecutor {
    public static final String ACTION_NAME = "writeJsonFile";
    private static final Logger logger = LoggerFactory.getLogger(WriteJsonFileActionStatementExecutor.class);
