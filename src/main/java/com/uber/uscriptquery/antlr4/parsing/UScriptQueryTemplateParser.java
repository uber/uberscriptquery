...
import com.uber.uscriptquery.antlr4.generated.UScriptQueryTemplateBaseListener;
import com.uber.uscriptquery.antlr4.generated.UScriptQueryTemplateLexer;
import com.uber.uscriptquery.util.TemplateUtils;
...
public class UScriptQueryTemplateParser {
    private static final Logger logger = LoggerFactory.getLogger(UScriptQueryTemplateParser.class);

    public UScriptQueryTemplateParseResult parse(String text) {
        return parse(text, null);
    }

    public UScriptQueryTemplateParseResult parse(String text, Map<String, Object> variableOverwrite) {
        final char[] charArray = text.toCharArray();

        final char[] charArrayUpperCase = text.toUpperCase().toCharArray();

        final UScriptQueryTemplateParseResult parsedResult = new UScriptQueryTemplateParseResult();

        UScriptQueryTemplateLexer l = new UScriptQueryTemplateLexer(new ANTLRInputStream(charArrayUpperCase, charArrayUpperCase.length));
        com.uber.uscriptquery.antlr4.generated.UScriptQueryTemplateParser p = new com.uber.uscriptquery.antlr4.generated.UScriptQueryTemplateParser(new CommonTokenStream(l));
        ...
        p.addParseListener(
                new UScriptQueryTemplateBaseListener() {
                    @Override
                    public void exitVariableAssignment(com.uber.uscriptquery.antlr4.generated.UScriptQueryTemplateParser.VariableAssignmentContext ctx) {
                    ...
                    @Override
                    public void exitAssignmentWithSemicolon(com.uber.uscriptquery.antlr4.generated.UScriptQueryTemplateParser.AssignmentWithSemicolonContext ctx) {
                        lastOffset.set(ctx.getStop().getStopIndex());
                    }
                });
