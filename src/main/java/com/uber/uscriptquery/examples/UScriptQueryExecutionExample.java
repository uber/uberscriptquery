...
import com.uber.uscriptquery.util.JsonUtils;
...
/**
 * This class contains example codes to use uScriptQuery to run Spark SQL job.
 */
public class UScriptQueryExecutionExample {
    ...
    public static void main(String[] args) {
        ...
        String appName = "UScriptQueryExecutionExample";
